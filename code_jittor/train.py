...
def main():
    ...
    parser.add_argument('--yaml', type=str, default='./code_jittor/yaml/table/surface/train_geovae.yml', help='yaml config file')
    ...
    for e in range(clock.epoch, config['train']['epoch']):
        ...
        if clock.epoch % 2 == 0:
            tr_agent.save_ckpt('latest')
        # print(tr_agent.net.encoder.main[0].weight.device)
        # print(tr_agent.net.encoder.main[0].weight.device)
